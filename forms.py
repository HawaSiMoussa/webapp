...
class RegisterForm(FlaskForm):
    ...
    hwrmail = EmailField(
        "HWR-Mail",
        validators=[InputRequired(), Email(), Regexp(r'^[a-zA-Z0-9._%+-]+@(hwr-berlin\.de|stud\.hwr-berlin\.de|doz\.hwr-berlin\.de)$', message="Bitte geben Sie ihre gültige HWR-Mail-Adresse ein.")]
    )
